...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $projeto['id'] ?>" data-projeto="<?= $projeto['projeto'] ?>" data-descricao="<?= $projeto['descricao'] ?>" data-id_equipe="<?= $projeto['id_equipe'] ?>">Editar</button>
        <a href="/projeto/delete/<?= $projeto['id'] ?>" class="btn btn-sm btn-danger">Excluir</a>
      </td>
    </tr>
    <?php } ?>
  </tbody>
